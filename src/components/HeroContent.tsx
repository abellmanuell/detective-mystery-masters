...
const HeroContent = () => {
  return (
    ...
    >
      ...
      <div className="flex grow flex-col justify-center gap-6 lg:items-center">
        <SocialProofs
          proofs={socialPropfs}
          rate="4.5 / 5.0"
          players="145,000+"
        ...
        <h1 className="font-bebas-neue text-5xl md:text-7xl lg:text-center">
          Think You Can <br /> Crack The Case?
        </h1>

        <p className="text-xl">Gather Friends, Solve Crimes, Become the Hero</p>
